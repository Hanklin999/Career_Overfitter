...
with tab3:
    ...
    if c_data:
        ...
        fig3.add_trace(go.Scatter(
            ...
            y=sn,
            mode="markers",
            marker=dict(color="#1e3a5f", size=11),
            name=label_a
        ))
        ...
        fig3.add_trace(go.Scatter(
            ...
            y=sn,
            mode="markers",
            marker=dict(color="#6b5b4e", size=11),
            name=label_b
        ))
